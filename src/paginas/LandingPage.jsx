...
/*ok*/
  ...
  return (
      ...
      />
        ...
        <h1 style={{ textAlign: 'center', color: 'white', fontSize: '4em', WebkitTextStroke: '2px darkgray'  }}>BIENVENIDOS</h1>
        <p style={{ textAlign: 'center', color: 'white', fontSize: '1.8em', fontWeight: 'bold', WebkitTextStroke: '1px darkgray' }}>EXPERIMENTA LA SENSACIÓN DEL FRIO CON ESTE CUBO DE HIELO GIGANTE! DESCUBRE COMO LA REALIDAD AUMENTADA PUEDE TRANSFORMAR TU ALREDEDOR!</p>
