...
/*ok*/
  ...
  return (
      ...
      />
        ...
        <p style={{ textAlign: 'center', color: 'white', fontSize: '1.8em', WebkitTextStroke: '2px darkgray' }}>EXPERIMENTA LA SENSACIÓN DEL FRIO CON ESTE CUBO DE HIELO GIGANTE! DESCUBRE COMO LA REALIDAD AUMENTADA PUEDE TRANSFORMAR TU ALREDEDOR!</p>
